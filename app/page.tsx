      ...
      {isPro && (
        <div className="rounded-2xl border border-blue-100 bg-gradient-to-br from-blue-50 to-indigo-50 p-4 shadow-sm">
          <div className="flex items-start justify-between gap-3 mb-3">
            <div>
              <p className="text-sm font-semibold text-blue-900">Cómo usar Pro</p>
              <p className="text-xs text-blue-600">Empieza por buscar y luego filtra o compara según tu caso clínico.</p>
            </div>
            <button
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
            {[
              { step: '1', title: 'Buscar', text: 'Escribe nombre comercial o principio activo.' },
              { step: '2', title: 'Filtrar', text: 'Explora por grupo clínico cuando quieras acotar.' },
              { step: '3', title: 'Comparar', text: 'Selecciona hasta 5 fármacos y revisa diferencias.' },
            ].map(item => (
              <div key={item.step} className="rounded-xl border border-blue-100 bg-white p-3">
